...
\subsection*{Undergraduate Research}
	...
	\item Documented progress in a weekly blog, and reported results in presentations and poster sessions
	\end{itemize*}
...
\begin{description*}
	\item[Software:]
	Eagle, MATLAB, R, \LaTeX, Git, BASH, Mathematica, Microsoft Technology Associate Certifications
	\item[Hardware:]
	Arduino, Raspberry Pi, Soldering, Oscilloscope, Logic Analyzer, Voltmeter, Carpentry, Laser Cutting 
\end{description*}
