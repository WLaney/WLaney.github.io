...
\headerrow
	...
	\begin{itemize*}
		\item Developed system level testing frameworks in Python for use in a production environment
		\item Responsible for designing and implementing printed circuit board (PCB) level electrical tests
		\item Documented ISO compliant manufacturing processes and procedures
	\end{itemize*}
\headerrow
...
\begin{description*}
	\item[Software:]
	MATLAB, Eagle, R, Python \LaTeX, Git, BASH, I$^2$C, SPI, Microsoft Technology Associate Certifications
	\item[Hardware:]
