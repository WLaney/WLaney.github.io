...
\begin{description*}
	\item[Software:]
	MATLAB, Eagle, R, \LaTeX, Git, BASH, Mathematica, Microsoft Technology Associate Certifications
	\item[Hardware:]
	Arduino, Rasperry Pi, Soldering, Oscilloscope, Logic Analyzer, Voltmeter, Carpentry, Laser Cutting 
\end{description*}
